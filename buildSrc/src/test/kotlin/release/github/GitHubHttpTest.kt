...
class GitHubHttpTest {
    ...
    private object LatestReleaseVersionTestSuite : TestSuite<ReleaseVersionOutcome>("latest release version", publicKeyInfrastructure) {
        ...
        override val sunnyDayResponse =
            """[{"url":"https://api.github.com/repos/argo-json/argo/releases/153674301","assets_url":"https://api.github.com/repos/argo-json/argo/releases/153674301/assets","upload_url":"https://uploads.github.com/repos/argo-json/argo/releases/153674301/assets{?name,label}","html_url":"https://github.com/argo-json/argo/releases/tag/4.16","id":153674301,"author":{"login":"markslater","id":642523,"node_id":"MDQ6VXNlcjY0MjUyMw==","avatar_url":"https://avatars.githubusercontent.com/u/642523?v=4","gravatar_id":"","url":"https://api.github.com/users/markslater","html_url":"https://github.com/markslater","followers_url":"https://api.github.com/users/markslater/followers","following_url":"https://api.github.com/users/markslater/following{/other_user}","gists_url":"https://api.github.com/users/markslater/gists{/gist_id}","starred_url":"https://api.github.com/users/markslater/starred{/owner}{/repo}","subscriptions_url":"https://api.github.com/users/markslater/subscriptions","organizations_url":"https://api.github.com/users/markslater/orgs","repos_url":"https://api.github.com/users/markslater/repos","events_url":"https://api.github.com/users/markslater/events{/privacy}","received_events_url":"https://api.github.com/users/markslater/received_events","type":"User","site_admin":false},"node_id":"RE_kwDOLzFRO84JKOI9","tag_name":"4.16","target_commitish":"main","name":null,"draft":false,"prerelease":false,"created_at":"2024-05-01T14:29:16Z","published_at":"2024-05-01T14:40:59Z","assets":[{"url":"https://api.github.com/repos/argo-json/argo/releases/assets/165352014","id":165352014,"node_id":"RA_kwDOLzFRO84J2xJO","name":"argo-4.16.jar","label":"Jar","uploader":{"login":"markslater","id":642523,"node_id":"MDQ6VXNlcjY0MjUyMw==","avatar_url":"https://avatars.githubusercontent.com/u/642523?v=4","gravatar_id":"","url":"https://api.github.com/users/markslater","html_url":"https://github.com/markslater","followers_url":"https://api.github.com/users/markslater/followers","following_url":"https://api.github.com/users/markslater/following{/other_user}","gists_url":"https://api.github.com/users/markslater/gists{/gist_id}","starred_url":"https://api.github.com/users/markslater/starred{/owner}{/repo}","subscriptions_url":"https://api.github.com/users/markslater/subscriptions","organizations_url":"https://api.github.com/users/markslater/orgs","repos_url":"https://api.github.com/users/markslater/repos","events_url":"https://api.github.com/users/markslater/events{/privacy}","received_events_url":"https://api.github.com/users/markslater/received_events","type":"User","site_admin":false},"content_type":"application/java-archive","state":"uploaded","size":162044,"download_count":0,"created_at":"2024-05-01T14:41:00Z","updated_at":"2024-05-01T14:41:00Z","browser_download_url":"https://github.com/argo-json/argo/releases/download/4.16/argo-4.16.jar"},{"url":"https://api.github.com/repos/argo-json/argo/releases/assets/165352018","id":165352018,"node_id":"RA_kwDOLzFRO84J2xJS","name":"argo-small-4.16.jar","label":"Jar stripped of debug information","uploader":{"login":"markslater","id":642523,"node_id":"MDQ6VXNlcjY0MjUyMw==","avatar_url":"https://avatars.githubusercontent.com/u/642523?v=4","gravatar_id":"","url":"https://api.github.com/users/markslater","html_url":"https://github.com/markslater","followers_url":"https://api.github.com/users/markslater/followers","following_url":"https://api.github.com/users/markslater/following{/other_user}","gists_url":"https://api.github.com/users/markslater/gists{/gist_id}","starred_url":"https://api.github.com/users/markslater/starred{/owner}{/repo}","subscriptions_url":"https://api.github.com/users/markslater/subscriptions","organizations_url":"https://api.github.com/users/markslater/orgs","repos_url":"https://api.github.com/users/markslater/repos","events_url":"https://api.github.com/users/markslater/events{/privacy}","received_events_url":"https://api.github.com/users/markslater/received_events","type":"User","site_admin":false},"content_type":"application/java-archive","state":"uploaded","size":130743,"download_count":0,"created_at":"2024-05-01T14:41:01Z","updated_at":"2024-05-01T14:41:02Z","browser_download_url":"https://github.com/argo-json/argo/releases/download/4.16/argo-small-4.16.jar"},{"url":"https://api.github.com/repos/argo-json/argo/releases/assets/165352015","id":165352015,"node_id":"RA_kwDOLzFRO84J2xJP","name":"argo-with-source-4.16.jar","label":"Jar with source code included","uploader":{"login":"markslater","id":642523,"node_id":"MDQ6VXNlcjY0MjUyMw==","avatar_url":"https://avatars.githubusercontent.com/u/642523?v=4","gravatar_id":"","url":"https://api.github.com/users/markslater","html_url":"https://github.com/markslater","followers_url":"https://api.github.com/users/markslater/followers","following_url":"https://api.github.com/users/markslater/following{/other_user}","gists_url":"https://api.github.com/users/markslater/gists{/gist_id}","starred_url":"https://api.github.com/users/markslater/starred{/owner}{/repo}","subscriptions_url":"https://api.github.com/users/markslater/subscriptions","organizations_url":"https://api.github.com/users/markslater/orgs","repos_url":"https://api.github.com/users/markslater/repos","events_url":"https://api.github.com/users/markslater/events{/privacy}","received_events_url":"https://api.github.com/users/markslater/received_events","type":"User","site_admin":false},"content_type":"application/java-archive","state":"uploaded","size":219250,"download_count":0,"created_at":"2024-05-01T14:41:00Z","updated_at":"2024-05-01T14:41:01Z","browser_download_url":"https://github.com/argo-json/argo/releases/download/4.16/argo-with-source-4.16.jar"}],"tarball_url":"https://api.github.com/repos/argo-json/argo/tarball/4.16","zipball_url":"https://api.github.com/repos/argo-json/argo/zipball/4.16","body":null}]"""
    ...
    private object UploadArtifactTestSuite : TestSuite<UploadArtifactOutcome>("upload artifact", publicKeyInfrastructure) {
        ...
        @Suppress("SpellCheckingInspection")
        override val sunnyDayResponse =
            """{"url":"https://api.github.com/repos/argo-json/argo/releases/assets/167220330","id":167220330,"node_id":"RA_kwDOLzFRO84J95Rq","name":"argo-with-source-4.17.jar","label":"Jar with source code included","uploader":{"login":"markslater","id":642523,"node_id":"MDQ6VXNlcjY0MjUyMw==","avatar_url":"https://avatars.githubusercontent.com/u/642523?v=4","gravatar_id":"","url":"https://api.github.com/users/markslater","html_url":"https://github.com/markslater","followers_url":"https://api.github.com/users/markslater/followers","following_url":"https://api.github.com/users/markslater/following{/other_user}","gists_url":"https://api.github.com/users/markslater/gists{/gist_id}","starred_url":"https://api.github.com/users/markslater/starred{/owner}{/repo}","subscriptions_url":"https://api.github.com/users/markslater/subscriptions","organizations_url":"https://api.github.com/users/markslater/orgs","repos_url":"https://api.github.com/users/markslater/repos","events_url":"https://api.github.com/users/markslater/events{/privacy}","received_events_url":"https://api.github.com/users/markslater/received_events","type":"User","site_admin":false},"content_type":"application/java-archive","state":"uploaded","size":219250,"download_count":0,"created_at":"2024-05-10T19:28:07Z","updated_at":"2024-05-10T19:28:08Z","browser_download_url":"https://github.com/argo-json/argo/releases/download/4.17/argo-with-source-4.17.jar"}"""
