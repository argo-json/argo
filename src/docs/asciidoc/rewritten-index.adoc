...
|`Integer.MAX_VALUE` - 8
// TODO this is only tested with ArrayList instead of LinkedList in JsonArrayNodeBuilder, and with ImmutableList and JsonArrayNodeBuilder primed for Integer.MAX_VALUE - 8 elements.
|Unlimited
|`Integer.MAX_VALUE` - 8
|Unlimited
