...
Argo is compliant with https://datatracker.ietf.org/doc/html/rfc8259[RFC 8259].  It works with Java 5 onwards, and includes JPMS module information for Java 9 onwards.
