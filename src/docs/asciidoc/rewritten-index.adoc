...
[source,java]
----
include::{docfile}/../../java/ExamplesTest.java[tags=generateSomeJson, indent=0]
----
...
[source,json]
----
include::{docfile}/../../java/ExamplesTest.java[tags=generateSomeJsonResult, indent=0]
----

To retrieve the title from the blog entry JSON we produced, we parse it, and then extract the value of the `title` field.
[source,java]
----
include::{docfile}/../../java/ExamplesTest.java[tags=parseSomeJson, indent=0]
----
...
[source,java]
----
include::{docfile}/../../java/ExamplesTest.java[tags=streamOutSomeJson;!streamOutSomeJsonIntermediateResultWrapper, indent=0]
----
<1> Get a source of comments
<2> A `StringWriter` for demonstration purposes, but could be any `Writer`
<3> At this point, the `StringWriter` contains:
+
[source,json]
----
include::{docfile}/../../java/ExamplesTest.java[tags=streamOutSomeJsonIntermediateResult, indent=0]
----
...
[source,java]
----
include::{docfile}/../../java/ExamplesTest.java[tags=streamInSomeJson, indent=0]
----
