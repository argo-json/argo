...
class JsonStringEscapingWriterTest {
    ...
    void rejectsNullDelegate() {
        assertThrows(NullPointerException.class, () -> new JsonStringEscapingWriter(null));
    }
    ...
    void attemptingToWriteABufferWithOffsetAndLengthWhereOffsetIsNegativeThrowsIndexOutOfBoundsException() {
        try (JsonStringEscapingWriter jsonStringEscapingWriter = new JsonStringEscapingWriter(NullWriter.INSTANCE)) {
    ...
    void flushIsPropagatedToDelegate() throws IOException {
        try (FlushCountingWriter flushCountingWriter = new FlushCountingWriter(); JsonStringEscapingWriter jsonStringEscapingWriter = new JsonStringEscapingWriter(flushCountingWriter)) {
            jsonStringEscapingWriter.write("a");
    ...
    void closeIsNotPropagatedToDelegate() throws IOException {
        try (CloseCountingWriter closeCountingWriter = new CloseCountingWriter()) {
            final JsonStringEscapingWriter jsonStringEscapingWriter = new JsonStringEscapingWriter(closeCountingWriter);
            jsonStringEscapingWriter.write("a");
